...
Manages parallel simulations for dual platforms (Twitter and Reddit).
Uses preset scripts + LLM for intelligent generation of configuration parameters.
"""
...
class SimulationState:
    ...
    def to_simple_dict(self) -> Dict[str, Any]:
        """Simplified status dictionary (used for API responses)"""
        return {
            "simulation_id": self.simulation_id,
            "project_id": self.project_id,
            "graph_id": self.graph_id,
...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        3. Use LLM to intelligently generate simulation configuration parameters (time, activity, frequency, etc.).
        ...
        Args:
            ...
            document_text: Original document text (used for background context)
        ...
        try:
            ...
            # Reddit profiles are saved in real-time; resave here to ensure completeness
            if progress_callback:
                progress_callback(
            ...
            if progress_callback:
                progress_callback(
                    ...
                    f"Done, {len(profiles)} profiles created",
