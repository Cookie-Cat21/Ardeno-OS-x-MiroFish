...
class GraphBuilderService:
    ...
    Responsible for calling Zep API to build the knowledge graph
    """
    ...
    def _wait_for_episodes(
        ...
        """Wait for all episodes to complete processing (by checking processed status of each episode)"""
        ...
        if progress_callback:
            progress_callback(f"Starting wait for {total_episodes} chunks to be processed...", 0)
    ...
    def get_graph_data(self, graph_id: str) -> Dict[str, Any]:
        ...
        Returns:
            Dictionary containing nodes and edges, including temporal info, attributes, etc.
        """
        nodes = fetch_all_nodes(self.client, graph_id)
        edges = fetch_all_edges(self.client, graph_id)
