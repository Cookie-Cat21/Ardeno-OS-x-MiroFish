      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm bg-os-gold text-os-bg font-medium hover:bg-os-gold-dim transition-colors"
          >
        ...
        >
          ...
          <DragOverlay>
            {activeProject && (
              <div className={cn(
                'w-56 glass rounded-lg p-3.5 border shadow-card-hover opacity-90 rotate-1',
                STAGE_META[activeProject.stage].borderColor
              )}>
                <p className="text-os-text text-sm font-semibold">{activeProject.title}</p>
                <p className="text-os-muted text-[11px]">{activeProject.client_name}</p>
              </div>
            )}
          </DragOverlay>
        </DndContext>
